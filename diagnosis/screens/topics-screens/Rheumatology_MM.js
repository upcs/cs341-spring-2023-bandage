...
`;
  ...
  const handleShare = () => {
    Share.share({
      message: 'Check out this rheumatology multimedia content: https://physicaldiagnosispdx.com/rheumatology-multimedia/',
    });
  };
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <WebView
        ...
        source={{ uri: 'https://physicaldiagnosispdx.com/rheumatology-multimedia/'}}
        onMessage={onMessage}
