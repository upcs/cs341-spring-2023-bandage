...
`;
  ...
  const handleShare = () => {
    Share.share({
      message: 'Check out this Hereditary conditions multimedia content: https://physicaldiagnosispdx.com/hereditary-conditions-2/',
    });
  };
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <WebView
        ...
        source={{ uri: 'https://physicaldiagnosispdx.com/hereditary-conditions-2/'}}
        onMessage={onMessage}
