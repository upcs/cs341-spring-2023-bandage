...
`;
  ...
  const handleShare = () => {
    Share.share({
      message: 'Check out this Hematology-Oncology multimedia content: https://physicaldiagnosispdx.com/hematology-oncology-m/',
    });
  };
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <WebView
        ...
        source={{ uri: 'https://physicaldiagnosispdx.com/hematology-oncology-m/'}}
        onMessage={onMessage}
