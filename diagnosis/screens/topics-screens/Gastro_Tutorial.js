...
`;
  ...
  const handleShare = () => {
    Share.share({
      message: 'Check out this Gastroenterology tutorial content: https://physicaldiagnosispdx.com/gastroenterology/',
    });
  };
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <WebView
        ...
        source={{ uri: 'https://physicaldiagnosispdx.com/gastroenterology/'}}
        onMessage={onMessage}
