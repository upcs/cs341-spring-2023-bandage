...
`;
  ...
  const handleShare = () => {
    Share.share({
      message: 'Check out this Endocrinology multimedia content: https://physicaldiagnosispdx.com/endocrinology-multimedia/',
    });
  };
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <WebView
        ...
        source={{ uri: 'https://physicaldiagnosispdx.com/endocrinology-multimedia/'}}
        onMessage={onMessage}
