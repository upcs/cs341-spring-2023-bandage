...
`;
  ...
  const handleShare = () => {
    Share.share({
      message: 'Check out this Gastroenterology multimedia content: https://physicaldiagnosispdx.com/gastroentereology-m/',
    });
  };
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <WebView
        ...
        source={{ uri: 'https://physicaldiagnosispdx.com/gastroentereology-m/'}}
        onMessage={onMessage}
